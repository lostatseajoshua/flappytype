...
class TextGameModel {
    ...
    private var newWords = ["follow","sea","baby","money","story","catalog","idiom","invalid","request","requesting","subtype","without","specifying","source","control","window","debug","editor","battery","January","February","March","April","May","June","July","August","September","November","December"]
    ...
    init() {
        ...
        gameModelWords.appendContentsOf(self.newWords)
